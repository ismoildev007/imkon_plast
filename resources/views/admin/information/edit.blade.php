    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Katolog tahrirlash</h4>
                    </div>
{{--                    <div class="col-lg-6">--}}
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <select name="category_id" class="form-control" id="">
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ old('category', $information->category_id) == $category->id ? 'selected : ' : '' }}>{{ $category['name_' . $lang] }}</option>
                            @endforeach
                        </select>
                    </div>
