...
{{--                    </div>--}}
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('price.store')}}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    {{-- uz --}}
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-25 my-5">
                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="price" placeholder="Narxni kiriting">
                        </div>
                    </div>
