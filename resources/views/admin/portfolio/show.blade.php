    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Portfolio Show</h4>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    <label class="form-label">Kv m ( hajmi ) --</label>
                                    <span>{{ $portfolio->kv_m }} m kv</span>
                                </div>
                                <div class="col-md-4">
                                    <a href="{{ route('portfolio.edit', $portfolio->id) }}" class="btn btn-primary btn-squared px-30 mb-3">O'zgartirish</a><br>
