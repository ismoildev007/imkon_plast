                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="{{ route('service.edit', $service->id) }}" class="btn btn-primary btn-squared px-30 mb-3">O'zgartirish</a><br>
                                    <a href="{{ route('service.index') }}" class="btn btn-default btn-squared btn-light px-20">Orqaga</a>
