    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Vazafi va Missiya va qadriyatlarimiz</h4>
                    </div>
                    <div class="col-lg-6">
                        <div class="d-none d-lg-block">
                            <ol class="breadcrumb m-0 float-end">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Mission sahifa</a></li>
            ...
            <div class="row mb-3">
                <div>
                    <a class="btn btn-primary" href="{{ route('mission.create') }}">Create</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                ...
                                @foreach($taskMission as $mission)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('mission.show', $mission->id) }}"><i class="mdi mdi-eye fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <form action="{{ route('mission.destroy', $mission->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                    @csrf
                                                    @method('DELETE')
