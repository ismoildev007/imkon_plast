    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Bizning jamoa Ro'yxati</h4>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="row mb-3">
                <div>
                    <a class="btn btn-primary" href="{{ route('team.create') }}">Yaratish</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('team.edit', $new->id) }}"><i class="mdi mdi-book-edit-outline fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('team.show', $new->id) }}"><i class="mdi mdi-eye fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <form action="{{ route('team.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                    @csrf
                                                    @method('DELETE')
