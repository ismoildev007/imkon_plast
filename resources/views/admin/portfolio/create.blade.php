    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('portfolio.store')}}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    {{-- uz --}}
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-25 my-5">
                                <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="kv_m" placeholder="m kv hajmini kiriting">
                            </div>
                        </div>
                    </div>
